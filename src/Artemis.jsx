...
.cal{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:5px;width:100%;min-width:0}
.cell{min-height:64px;min-width:0;padding:4px;border:1.8px solid var(--line);border-radius:9px;background:var(--panel);transition:background .1s;overflow:hidden}
...
.ev{font-size:12.5px;line-height:1.2;margin-top:2px;padding:1px 5px;border-radius:5px;background:var(--accent2);color:var(--panel);
  min-width:0;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display:block}
